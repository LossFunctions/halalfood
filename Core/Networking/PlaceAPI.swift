...
enum PlaceAPI {
    ...
    private static func searchPlacesViaLegacy(query: String, normalizedQuery: String, limit: Int) async throws -> [PlaceDTO] {
        ...
        let selectColumns = "id,name,category,lat,lon,address,display_location,halal_status,rating,rating_count,serves_alcohol,source,source_id,external_id,google_place_id,google_match_status,google_maps_url,google_business_status,apple_place_id,note,cc_certifier_org"
