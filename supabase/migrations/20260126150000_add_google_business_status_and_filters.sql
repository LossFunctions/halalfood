alter table public.place
    ...
    add column if not exists google_business_status_updated_at timestamptz;

create index if not exists place_google_business_status_idx
    on public.place (google_business_status);
